...
public class OpsLoggerFactory {
    ...
    /**
     * Enable/disable asynchronous logging.  When disabled, the log(...) method call does not return until the message
     * is fully converted to a string and written to the target file/output stream.
